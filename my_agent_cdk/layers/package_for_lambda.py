...
def create_lambda_package():
    ...
    # Since the script is in layers/ directory, we need to look for strands in the same directory
    script_dir = Path(__file__).parent
    packaging_dir = script_dir / "strands"
    ...
    print(f"Lambda deployment packages created successfully: {dependencies_deployment_zip.name}")
    return True
